...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProfileContainer = __webpack_require__(148);

	function _interopRequireDefault(obj) {
	  return obj && obj.__esModule ? obj : { default: obj };
	}

	console.log('profileContainer:', _ProfileContainer.ProfileContainer);
	...
	var dummyState = {
	  ...
	  profileInfoItems: [{ city: 'Austin' }, { state: 'Virginia' }]
	};

	_reactDom2.default.render(React.createElement(_ProfileContainer.ProfileContainer, dummyState), document.getElementById('reactContainer'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProfileInfoItem = __webpack_require__(161);

	var _UserImage = __webpack_require__(162);

	var _ProfileInfoItemList = __webpack_require__(163);
	...
	var ProfileContainer = exports.ProfileContainer = function (_React$Component) {
	  _inherits(ProfileContainer, _React$Component);

	  function ProfileContainer(_ref) {
	    var user = _ref.user;
	    var profileInfoItems = _ref.profileInfoItems;
	    var friends = _ref.friends;

	    _classCallCheck(this, ProfileContainer);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ProfileContainer).call(this));

	    _this.user = user;
	    _this.profileInfoItems = profileInfoItems;
	  ...
	  _createClass(ProfileContainer, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement('div', { className: 'ProfileContainer' }, _react2.default.createElement(_UserImage.UserImage, _extends({}, this.user, { imageType: 'portrait' })), _react2.default.createElement(_ProfileInfoItemList.ProfileInfoItemList, { profileInfoItems: this.profileInfoItems }), _react2.default.createElement(FriendItemList, { friends: this.friends }));
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	exports.ProfileInfoItem = ProfileInfoItem;
	function nullFn() {};

	function ProfileInfoItem(_ref) {
	  var profileItemTitle = _ref.profileItemTitle;
	  var profileItemDesc = _ref.profileItemDesc;
	  var _ref$onProfileItemCli = _ref.onProfileItemClick;
	  var onProfileItemClick = _ref$onProfileItemCli === undefined ? nullFn : _ref$onProfileItemCli;

	  return React.createElement("div", { className: "ProfileInfoItem", onClick: onProfileItemClick }, React.createElement("span", { className: "ProfileInfoItemTitle" }, profileItemTitle), React.createElement("span", { className: "ProfileInfoItemDesc" }, profileItemDesc));
	};
...
/***/ function(module, exports) {
	...
	function UserImage(_ref) {
	  ...
	  return React.createElement("div", { className: "avatar" }, imageType === 'portrait' ? React.createElement("img", { className: "userPortrait", src: avatar /*  portrait size */ }) : React.createElement("img", { className: "userIcon", src: avatar /*  icon size  */ }));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ProfileInfoItemList = ProfileInfoItemList;

	var _ProfileInfoItem = __webpack_require__(161);

	function ProfileInfoItemList(_ref) {
	  var profileInfoItems = _ref.profileInfoItems;

	  return React.createElement("div", { className: "ProfileInfoItemList" }, profileInfoItems.map(function (profileItem) {
	    return React.createElement(_ProfileInfoItem.ProfileInfoItem, profileItem);
	  }));
	};
