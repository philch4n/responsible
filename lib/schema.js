...
.createTableIfNotExists('rider', function (table) {
...
.createTableIfNotExists('driver', function (table) {
...
.createTableIfNotExists('rides', function (table) {
  ...
  table.integer('ride_driver').references('driver_id').inTable('driver').notNullable();
  table.integer('ride_rider').references('rider_id').inTable('rider').notNullable();
